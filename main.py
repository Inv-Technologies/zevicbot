...
# --------- #
prefix = [">", "join.", "mod." ]
embed_role = "Zevic" # The role in your server used for embedding.
game = "Type .help" # This will display as the game on Discord.
# ---------- #
...
async def help(ctx):
    ...
    embed = discord.Embed(title="ShadowBot Help Menu", description="Here you will find all the help you need. Not satisfied? Type join.supportserver, to join our Official Support Server.", color=0x00a0ea)
    embed.add_field(name="My prefixes".format("null"), value="> for general commands | join. for joining support server |mod. for mod commands")
    embed.set_thumbnail(url = "https://thumb.ibb.co/egxUR7/LCC_Logo_idea_2.png")
    ...
    embed.set_footer(text="Shadow Bot ~ Developed by Alphi#5113")
